...
/**
  ...
  *
  * Currently, two demo methods are available. Both simply print a text 
file to the
  * terminal. One returns exceptions in case of a problem, the other prints 
out
  * error messages.
  *
...
public class FileReader
{
     ...
     /**
      * Show the contents of the file 'fileName' on standard out (the text 
terminal).
      *
         ...
         throws IOException
     {
         ...
         // wrap the stream into an InputStreamReader, so that we read 

         // rather than bytes (important for non-ascii characters); then 

         // a BufferedReader, so that we can read lines, rather than single 
